...
class ScrabbleVectorizer {
   public:
     ...
     */
    virtual std::vector<scl::ScrabbleString> return_formatted_board_copy() const = 0;
     ...
     */
    virtual std::vector<scl::ScrabbleString> &get_all_moves_at(int x, int y) = 0;
    ...
    /**
     * @brief Places the scl::Tiles of the passed scl::ScrabbleWord into the current board of this vectorizer based off of the coordinates of each scl::Tile in the passed scl::ScrabbleWord.
     * @warning After placing the passed scl::ScrabbleWord into the board, the perk-board may need to be prepared via "void update_perkBoard()".
     */
    virtual void raw_place_boarded_word(const scl::ScrabbleString &);

    /**
     * @brief Returns the points of the passed scl::ScrabbleWord, this point calculation includes perks and the points generated from creating neighboring words.
     * @attention Assumes that the passed scl::ScrabbleWord has proper coordinate values for the given vectorizer type.
     */
    virtual int points_of_raw_boarded_tstr(const scl::ScrabbleString &word) const;
     ...
     */
    std::vector<scl::ScrabbleString> &get_raw_board() { return board; }
    ...
    /**
     * @brief Sets the board of this vectorizer to the passed std::vector<scl::ScrabbleWord>
     * @warning The passed std::vector<scl::ScrabbleWord> needs to be formatted with respect to this vectorizer
     */
    void set_raw_board(const std::vector<scl::ScrabbleString> &passed) { board = passed; }
     ...
     */
    std::vector<scl::ScrabbleString> **get_moveSets() { return moveSets; }
    ...
    /**
     * @brief Returns true if the passed scl::ScrabbleWord contains at least one letter of the rack of this vectorizer.
     */
    bool contains_letter_of_rack(const scl::ScrabbleString &) const;

    ~ScrabbleVectorizer();

   protected:
    /**
     * @brief Returns a copy of this vectorizers current board that has the passed scl::ScrabbleWord placed into it.
     ...
     */
    virtual std::vector<scl::ScrabbleString> return_raw_board_with(const scl::ScrabbleString &) const;
    ...
    std::vector<scl::ScrabbleString> **moveSets;
    std::vector<scl::ScrabbleString> board;
    CADS wordDataset;
