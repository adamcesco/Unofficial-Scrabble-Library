...
public:
    ...
    void check_adjacent_compatibility();                        //checks each horizontal word for each row to see if it is compatible with adjacent rows
...
private:
    ...
    Type readerType;                //states whether the best word for the board is horizontal, this is not supported yet
