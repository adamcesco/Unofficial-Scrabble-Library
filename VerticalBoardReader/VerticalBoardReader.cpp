...
void VerticalBoardReader::search_board_for_words() { //calls too many functions
    if(answerSet.empty())
...
vector<LString> VerticalBoardReader::return_board_with(const LString &toPrint) const {
