...
int main(int argc, char* argv[]) {
    ...
    std::string rack = "THASER?";  // blank tiles should be marked as a '?', and the letters within the rack need to be upper-case
    ...
    std::cout << std::endl
              << "Horizontal Vectorizer Board:" << std::endl;
    hReader.console_print_formatted_board();
    std::cout << std::endl
              << "Vertical Vectorizer Board:" << std::endl;
